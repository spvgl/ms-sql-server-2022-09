-- два подхода
--1) разово проходим в цикле и собираем данные
--https://www.codeproject.com/Articles/647950/Create-and-Populate-Date-Dimension-for-Data-Wareho
--2) запускаем хранимую процедуру и заполняем в диапазоне дат
-- https://github.com/ziaa/SqlPersianDateDimension/blob/master/spPopulatePersianDateDimension.sql
